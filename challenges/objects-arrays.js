...
for(let i = 0; i < graduates.length; i++) {
	if(universities[i].indexOf(test) !== -1) {
		uni[count] = universities[i];
		count++;
	}
}
console.log(uni);
...
zooAnimals.forEach(function(element) {
	let name = `Name: ${element.animal_name}, Scientific: ${element.scientific_name}`;
...
*/
const populationTotal = zooAnimals.reduce(function(total, element) {
